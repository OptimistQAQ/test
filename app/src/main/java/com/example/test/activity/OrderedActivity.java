...
import com.example.test.bean.OrderItem;
                ...
                orderDlg.setOnDismissListener(new DialogInterface.OnDismissListener() {
                    ...
                    public void onDismiss(DialogInterface dialog) {
                        if (orderDlg.mBtnClicked == OrderOneDialog.ButtonID.BUTTON_OK) {
                            ...
                            {
                                appInstance.g_cart.DeleteOneOrderItem(newDish.mName);
                            } else //修改购物车中该菜品的数量
                            {
                                appInstance.g_cart.ModifyOneOrderItem(newDish.mName, orderDlg.mNum);
                            }
